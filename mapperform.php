                    ...
                    <div id="Body">
                        <div id="Content">
                            ...
                            <div class="Login_Form">
                                ...
                                <form action="mapper.process.php" method="POST">
                                    ...
                                    <label>حسابك على الفيسبوك
                                        <input type="text" name="fbaccount" class="login_email" required>
                                    </label>
                                    <label>تخصصك في المابات
                                        <input type="text" name="mapperjob" class="login_email" required>
                                    </label>
                                    <label>رابط احد اعمالك
                                        <input type="text" name="map-link" class="login_email" required>
                                    </label>
