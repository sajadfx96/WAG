                    ...
                    <div id="Body">
                        <div id="Content">
                            ...
                            <div class="Login_Form">
                                ...
                                <form action="scripter.process.php" method="POST">
                                    ...
                                    <label>تخصصك في البرمجة
                                        <input type="text" name="dev-specialty" class="login_email" required>
                                    </label>
                                    <label>رابط احد اعمالك
                                        <input type="text" name="script-link" class="login_email" required>
                                    </label>
