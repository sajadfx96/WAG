                            ...
                            <div id="Content">
                                <div class="spacer">
                                    <div class="spacer_content">
                                        <h1>اختر الرتبة</h1>
                                        <h2>اختر رتبة واكمل الحقول المطلوبة</h2>
                                ...
                                <div class="contact_block">
                                    ...
                                    <div><a href="adminform.php">تقديم</a></div>
                                </div>
                                <!--contact_block-->
                                <div class="contact_block">
                                    <h2>Support</h2>
                                    <p class="on">التقديم(مفتوح)</p>
                                    <div><a href="supportform.php">تقديم</a></div>
                                </div>
                                <!--contact_block-->
                                <div class="contact_block">
                                    <h2>Scripter</h2>
                                    <p class="on">التقديم(مفتوح)</p>
                                    <div><a href="scripterform.php">تقديم</a></div>
                                </div>
                                <!--contact_block-->
                                <div class="contact_block">
                                    <h2>Mapper</h2>
                                    <p class="on">التقديم(مفتوح)</p>
                                    <div><a href="mapperform.php">تقديم</a></div>
                                </div>
                                <!--contact_block-->
