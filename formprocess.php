...
if(isset($_POST['submit']))
{
    ...
    $mail->isHTML(true);
    $mail->Subject='MTA JOB ';
    $mail->Body='<h3>Name: '.$_POST['fulname'].'<br>Email: '.$_POST['email'].'<br>age: '.$_POST['age'].'<br>height: '.$_POST['height'].'<br>PhoneNumber: '.$_POST['phonenumber'].'<br>Gender: '.$_POST['sex'].'<br>JOB: '.$_POST['job'].'</h3>';
    if(!$mail->send())
    {
