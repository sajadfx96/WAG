...
if(isset($_POST['submit']))
{
    ...
    $mail->isHTML(true);
    $mail->Subject='Rank Scripter';
    $mail->Body='<h3>Name: '.$_POST['fulname'].'<br>Email: '.$_POST['email'].'<br>Facebook: '.$_POST['facebook'].'<br>Dev-Specialty: '.$_POST['dev-specialty'].'<br>Script-link: '.$_POST['script-link'].'</h3>';
    if(!$mail->send())
    {
